...
import MyFrameworkDeisgn.pageobjects.OrderPage;
...
public class SubmitOrderTest extends BaseTest{
	...
	{
		List<HashMap<String,String>> data = getJsonDataToMap(System.getProperty("user.dir")+"\\src\\test\\java\\MyFrameworkDesign\\data\\PurchaseOrder.json");
	...
	public void getDataa(){
		...
		map.put("email", "chinnu00@gmail.com");
		map.put("password", "Chinnu@97");
		map.put("product", "ZARA COAT 1");
